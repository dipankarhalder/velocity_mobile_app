...
export default function PhoneDetailsPage() {
  ...
  const filteredData = phoneList.find((item) => item.id === numericId);
    ...
    <View className="flex-1 bg-white relative">
      ...
      >
        <View className="w-full relative">
          {filteredData && (
            <View className="w-full bg-white flex items-center relative pt-[80px] pb-[30px]">
              <Image
                source={filteredData.imgUrl}
                className="w-[270px] h-[340px]"
              />
            </View>
          )}
        ...
        {filteredData ? (
          <View className="w-full pt-[26px] px-[26px] relative">
            ...
            <View className="w-full mb-7">
              ...
              {filteredData.price !== filteredData.mainPrice && (
              ...
              <View className="flex-row justify-between items-center">
                ...
                <Text
                  className={`text-black text-[15px] text-gray-700 font-nunitosans-bold ${filteredData.price !== filteredData.mainPrice ? "line-through" : ""}`}
                >
